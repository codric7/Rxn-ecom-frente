      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={()=>setMethod('stripe')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer rounded-md hover:scale-105 hover:border-blue-700 hover:bg-blue-100' >
                <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'stripe' ? 'bg-blue-400' : ''}`}></p>
                <img src={assets.stripe_logo} alt="" className='h-5 mx-4'/>
            </div>
            <div onClick={()=>setMethod('razorpay')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer rounded-md hover:scale-105 hover:border-purple-700 hover:bg-purple-100' >
                <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay' ? 'bg-purple-400' : ''}`}></p>
                <img src={assets.razorpay_logo} alt="" className='h-5 mx-4'/>
            </div>
            <div onClick={()=>setMethod('cod')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer rounded-md hover:scale-105 hover:border-green-700 hover:bg-green-100' >
          ...
          <div className='w-full text-end mt-8'>
              <button onClick={()=>navigate('/orders')} className='bg-black text-white px-16 py-3 text-sm rounded-md hover:bg-gray-400 hover:text-orange-700 cursor-pointer' >PLACE ORDER</button>
          </div>
        </div>
      </div>
