            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                <div className='flex items-start gap-6'>
                  ...
                  {/* in the updateQuantity() quantity parameter we put zero i.e '0' to remove all of the product from the cart */}
              </div>
            )
      })
        }
        ...
        <div className='flex justify-end my-20'>
          <div className='w-full sm:w-[450px]'>
            ...
            <div className='w-full text-end'>
              <button onClick={()=>navigate('/place-order')} className='bg-black text-white text-sm my-8 px-8 py-3 rounded-md cursor-pointer hover:bg-gray-700 hover:text-blue-400 transition ease-in'>PROCEED TO CHECKOUT</button>
            </div>
          </div>
        </div>
