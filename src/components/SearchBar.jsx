...
export default function SearchBar() {
    ...
    // Lock the search component to only display in the collection page only and hidden in all othe pages
  ...
  return showSearch && visible ? (
    <div className='border-t border-b bg-gray-50 gap-2 text-center'>
